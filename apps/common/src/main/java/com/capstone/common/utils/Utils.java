...
public class Utils {
  ...
  public static @NonNull ResponseEntity<WrapperApiResponse> returnOkResponse(String message, Object data) {
    return buildResponse(HttpStatus.OK.value(), message, "handling successfully", data);
  }

  public static @NonNull ResponseEntity<WrapperApiResponse> returnCreatedResponse(String message) {
    return buildResponse(HttpStatus.CREATED.value(), message, "create successfully", null);
  }

  public static @NonNull ResponseEntity<WrapperApiResponse> returnBadRequestResponse(String message, Object data) {
    return buildResponse(HttpStatus.BAD_REQUEST.value(), message, "bad request", data);
  }

  public static @NonNull ResponseEntity<WrapperApiResponse> returnInternalServerErrorResponse(String message, Object data) {
    return buildResponse(HttpStatus.INTERNAL_SERVER_ERROR.value(), message, "There is an error happening", data);
  }

  public static @NonNull ResponseEntity<WrapperApiResponse> returnUnAuthorizedResponse(String message, Object data) {
    return buildResponse(HttpStatus.UNAUTHORIZED.value(), message, "You do not have right to access this resources", data);
  }

  public static @NonNull ResponseEntity<WrapperApiResponse> returnForbiddenResponse(String message, Object data) {
    return buildResponse(HttpStatus.FORBIDDEN.value(), message, "Your resources not found", data);
  }

  public static @NonNull ResponseEntity<WrapperApiResponse> returnNoContentResponse(String message) {
    return buildResponse(HttpStatus.NO_CONTENT.value(), message, "no content", null);
  }

  private static @NonNull ResponseEntity<WrapperApiResponse> buildResponse(int statusCode, String devMsg, String userMsg, Object data) {
